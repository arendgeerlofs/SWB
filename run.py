...
#                visualisations=["plot_agent", "plot_avg"], title_add="test")
...
#                [60, 120, 180, 240], [5/6, 4/6, 3/6, 2/6], "fin", title_add="fin")
# run_resilience(params, RUNS, ITERATIONS, "soc_cap_inf", [0.25, 4], SAMPLES,
#                [60, 120, 180, 240], [5/6, 4/6, 3/6, 2/6], "fin", title_add="fin")

# run_resilience(params, RUNS, ITERATIONS, "soc_cap_base", [0.01, 1], SAMPLES,
#                [60, 120, 180, 240], [5/6, 4/6, 3/6, 2/6], "nonfin", title_add="nonfin")
# run_resilience(params, RUNS, ITERATIONS, "soc_cap_inf", [0.25, 4], SAMPLES,
#                [60, 120, 180, 240], [5/6, 4/6, 3/6, 2/6], "nonfin", title_add="nonfin")

# # Heatmap
# run_two_var_heatmap(params, RUNS, ITERATIONS, (3, 3), ["intervention_gap", "hist_len"],
#                     [(1, 7), (1, 7)], title_add="hist_int_testtest", hist_gap_comb=False)
